    ...
    <>
        ...
        <List className={classes.dFlex}>
          <ListItem>
            <a href="/" title="Tour de Amsterdam Home">
              <Image
                src="https://assets.it22.nl/logo_white.png"
      ...
      <Section className={classes.padding0}>
        <List {...rest} className={clsx(classes.footer)}>
          ...
          <ListItem className={classes.footerLi}>
            <Image
              src="https://assets.it22.nl/payment_options_white.png"
              alt="Payment Options"
          ...
          >
            ...
            >
              <Image
                src="https://assets.it22.nl/icon-fb.png"
                alt="FB Icon"
                lazy={true}
            ...
            >
              <Image
                src="https://assets.it22.nl/icon-youtube.png"
                alt="Youtube Icon"
                lazy={true}
              />
            </Typography>
