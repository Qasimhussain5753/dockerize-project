          ...
          <div>
            ...
            <List disablePadding>
              <ListItem disableGutters data-aos="fade-up">
                <ListItemAvatar>
                  <Avatar
                    src="https://assets.it22.nl/contact-us/phone-icon.png"
                    srcSet="https://assets.it22.nl/contact-us/phone-icon.png 2x"
              ...
              <ListItem disableGutters data-aos="fade-up">
                <ListItemAvatar>
                  <Avatar
                    src="https://assets.it22.nl/contact-us/mail-icon.png"
                    srcSet="https://assets.it22.nl/contact-us/mail-icon.png 2x"
                    className={classes.icon}
                  />
                </ListItemAvatar>
                <ListItemText
              ...
              <ListItem disableGutters data-aos="fade-up">
                <ListItemAvatar>
                  <Avatar
                    src="https://assets.it22.nl/contact-us/marker-icon.png"
                    srcSet="https://assets.it22.nl/contact-us/marker-icon.png 2x"
              ...
              <ListItem disableGutters data-aos="fade-up">
                <ListItemAvatar>
                  <Avatar
                    src="https://assets.it22.nl/contact-us/clock-icon.png"
                    srcSet="https://assets.it22.nl/contact-us/clock-icon.png 2x"
                    className={classes.largeContentIcon}
                  />
                </ListItemAvatar>
                <ListItemText
