...
const useStyles = makeStyles(theme => ({
  leftHeroImage: {
    width: '50%',
    backgroundImage: "url('https://assets.it22.nl/login/left-hero-2.png')",
    background: 'white',
    objectFit: 'cover',
  ...
  rightHeroImage: {
    width: '50%',
    backgroundImage: "url('https://assets.it22.nl/login/right-hero-3.png')",
    background: 'white',
    objectFit: 'cover',
    backgroundSize: 'cover',
    backgroundRepeat: 'no-repeat',
        ...
        <a href="/" title="Go Back To Home Page">
          <div className={classes.leftHeroWrapper}>
            <div className={classes.leftSideLogo}>
              <Image src="https://assets.it22.nl/logo.png" />
            </div>
          </div>
        </a>
      </Grid>
