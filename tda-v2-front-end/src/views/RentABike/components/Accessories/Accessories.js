        ...
        <Grid item xs={12} sm={3} data-aos="fade-up">
          <CardBase withShadow liftUp className={classes.cardBase}>
            <div>
              ...
              <NoSsr>
                <Image
                  src="https://assets.it22.nl/rental/gps-icon.png"
        ...
        <Grid item xs={12} sm={3} data-aos="fade-up">
          <CardBase withShadow liftUp className={classes.cardBase}>
            <div>
              ...
              <NoSsr>
                <Image
                  src="https://assets.it22.nl/rental/shoe-icon.png"
                  className={classes.image}
                  alt="Navigation"
                  lazy={true}
                />
        ...
        <Grid item xs={12} sm={3} data-aos="fade-up">
          <CardBase withShadow liftUp className={classes.cardBase}>
            <div>
              ...
              <NoSsr>
                <Image
                  src="https://assets.it22.nl/rental/helmet-icon.png"
                  className={classes.image}
                  alt="Navigation"
                  lazy={true}
                />
        ...
        <Grid item xs={12} sm={3} data-aos="fade-up">
          <CardBase withShadow liftUp className={classes.cardBase}>
            <div>
              ...
              <NoSsr>
                <Image
                  src="https://assets.it22.nl/rental/bottle-icon.png"
                  className={classes.image}
                  alt="Navigation"
                  lazy={true}
                />
