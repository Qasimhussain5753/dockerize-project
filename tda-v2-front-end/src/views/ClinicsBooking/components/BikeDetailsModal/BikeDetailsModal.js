    ...
    <div>
      ...
      >
        <DialogTitle id="form-dialog-title" className={classes.dialogTitle}>
          Add Bicycle
          <img
            src="https://assets.it22.nl/bike-renting/close-icon.png"
            alt="Close Icon"
              ...
              <Grid item xs={12}>
                <Grid item xs={12} className={classes.addBicycleFrameWrapper}>
                  <div
                    ...
                    style={{
                      backgroundImage: `url('https://assets.it22.nl/bike-renting/mountain-bike.png')`,
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `url('https://assets.it22.nl/bike-renting/road-bike.png')`,
                    }}
                  >
                    <span className={classes.imageLabel}>1,80-1,8856ML</span>
                  </div>
              ...
              <Grid item xs={12}>
                <Grid item xs={12} className={classes.addPedalsWrapper}>
                  <div
                    ...
                    style={{
                      backgroundImage: `url('https://assets.it22.nl/bike-renting/pedal-1.png')`,
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `url('https://assets.it22.nl/bike-renting/pedal-2.png')`,
                    }}
                  >
              ...
              <Grid item xs={12} md={12} md={7} lg={7}>
                ...
                <Grid item xs={12} className={classes.addAccessoriesWrapper}>
                  <div
                    ...
                    style={{
                      backgroundImage: `url('https://assets.it22.nl/bike-renting/shoe.png')`,
                    }}
                  >
              ...
              <Grid item xs={12} md={12} md={5} lg={5}>
                ...
                <Grid item xs={12} className={classes.addAccessoriesWrapper}>
                  <div
                    ...
                    style={{
                      backgroundImage: `url('https://assets.it22.nl/bike-renting/gps.png')`,
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `url('https://assets.it22.nl/bike-renting/no-gps.png')`,
                    }}
                  >
